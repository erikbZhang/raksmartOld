...
class Privatea extends HomeBaseController
{
    ...
    public function index()
    {
        ...
        $details['a_introduction'] = "RAKsmart帮助用户建设与运维管理、托管私有云专家为用户提>供一站式私有云方案咨询设计、实施部署、运维管理与扩容优化服务";
...
";
        $details['a_introduction'] = "RAKsmart通过独特的裸机云配置产品，提供快速，稳定，安全>的云计算产品。";
        ...
        if(!empty($type)){
            ...
            foreach ($type as $k=>$v) {
                $where['type'] = $v['id'];
                $array = MConfiguration::getSelect($where,'*','10');
