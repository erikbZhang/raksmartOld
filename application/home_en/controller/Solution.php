...
class Solution extends HomeBaseController
{
    ...
    public function index()
    {
        ...
        $details['a_introduction'] = "RAKsmart通过提供专业的业务流程，为您带来省钱、省心、省>时、省力的一站式服务，帮助您实现即时部署，无忧购买！";
        $this->assign('title','定制化服务_全球托管方案_24*7技术支持-RAKsmart提供全球托管定制>化服务。');
	...
	public function trusteeship()
	{
		...
		//获取分类下的产品，最多十条数据
		$details['a_con'] = "美国服务器托管_香港服务器托管_整机柜托管-Raksmart全球数
据中心，提供一站式托管服务。";
        $details['a_introduction'] = "主机托管，服务器托管，美国服务器托管，整机柜托管";
        $this->assign('title','RAKsmart—提供最专业服务器托管服务，数据中心全球覆盖，专业技术>团队为您提供7*24小时全方位服务。');
        $this->assign('details',$details);
		$arr = [];
		if(!empty($type)){
			$where['status'] = 1;
		...
		$this->assign('product_name','Configurable Product');
		//获取数据中心设施内容
		$map['c_id'] = 5;
		$map['status'] = 1;
